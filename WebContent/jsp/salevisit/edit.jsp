...
<script type="text/javascript">
	$(function(){
		...
		$.post("${pageContext.request.contextPath }/customer_findAll.action",{},function(data){
			...
			$("#cust_id").prop("value","${customer.cust_id}")
		},"json");
		// 异步加载用户的数据
		$.post("${pageContext.request.contextPath }/user_findAll.action",{},function(data){
			...
			$("#user_id").prop("value","${user.user_id}")
		},"json");
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间</td>
								<td>
									<INPUT class=menu_time id="visit_time" type="date"
							...
							<TR>
								...
								<td>下次拜访时间 ：</td>
								<td>
								<INPUT class=menu_time id="visit_nexttime" type="date"
